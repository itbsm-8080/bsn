...
procedure TfrmBrowseFP.cxButton14Click(Sender: TObject);
begin
  inherited;
      frmFP.doslipRET(CDSMaster.FieldByname('Nomor').AsString);

end;

procedure TfrmBrowseFP.cxButton15Click(Sender: TObject);
begin
  inherited;
